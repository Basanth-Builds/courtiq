...
INSERT INTO matches (id, tournament_id, category_id, pool_id, team1, team2, stage, status, team1_score, team2_score, court_number) VALUES
  ('match_s_b_1', 'trn_demo', 'cat_singles', 'pool_singles_b', 'Player E', 'Player F', 'POOL', 'SCHEDULED', NULL, NULL, NULL),
  ('match_s_b_2', 'trn_demo', 'cat_singles', 'pool_singles_b', 'Player G', 'Player H', 'POOL', 'SCHEDULED', NULL, NULL, NULL);
...
INSERT INTO matches (id, tournament_id, category_id, pool_id, team1, team2, stage, status, team1_score, team2_score, court_number) VALUES
  ...
  ('match_d_a_3', 'trn_demo', 'cat_doubles', 'pool_doubles_a', 'Team Red', 'Team Green', 'POOL', 'SCHEDULED', NULL, NULL, NULL);
...
INSERT INTO matches (id, tournament_id, category_id, pool_id, team1, team2, stage, status, team1_score, team2_score, court_number) VALUES
  ('match_d38_a_1', 'trn_demo', 'cat_doubles_38', 'pool_doubles_38_a', 'Team Phoenix', 'Team Dragon', 'POOL', 'CONFIRMED', 11, 9, NULL),
  ('match_d38_a_2', 'trn_demo', 'cat_doubles_38', 'pool_doubles_38_a', 'Team Tiger', 'Team Lion', 'POOL', 'IN_PROGRESS', NULL, NULL, NULL);
