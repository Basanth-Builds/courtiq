...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-court-pattern text-white">
            ...
            {[
              {
                ...
                desc: 'Umpires enter scores from the court on any phone. Real-time sync to all screens instantly.',
                color: '#a8d634',
              },
              {
                icon: Trophy,
                title: 'Auto Seeding & Draws',
                desc: 'Pool standings, tie-breakers, and playoff brackets generated automatically by DUPR rating.',
                color: '#a8d634',
              },
              {
                icon: BarChart3,
                title: 'DUPR Submission',
                desc: 'Two-tap confirmation workflow. Umpire confirms, referee approves, DUPR CSV generated and submitted.',
                color: '#a8d634',
              },
              {
                icon: Users,
                title: 'Role-based Access',
                desc: 'Umpire, Referee, Admin, and Spectator roles. Everyone sees exactly what they need.',
                color: '#a8d634',
              },
              {
                icon: Smartphone,
                title: 'Mobile-first Design',
                desc: 'Court desk UI is built for quick thumb access. Works on any phone, no app install needed.',
                color: '#a8d634',
              },
              {
                icon: Shield,
                title: 'Audit Trail',
                desc: 'Every score change and confirmation is logged with timestamps and user identity.',
                color: '#a8d634',
              },
            ].map((feature) => (
              <div
                key={feature.title}
                className="p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-[#a8d634]/30 hover:bg-white/8 transition-all group"
              >
                <div className="w-12 h-12 rounded-xl bg-[#a8d634]/10 flex items-center justify-center mb-4 group-hover:bg-[#a8d634]/20 transition-all">
      ...
      {/* Workflow */}
      <section id="workflow" className="py-24 px-6 bg-white/2">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative">
            <div className="absolute left-8 top-0 bottom-0 w-px bg-gradient-to-b from-[#a8d634] via-[#a8d634]/50 to-transparent" />
            {[
              ...
              <div key={i} className="relative flex gap-6 mb-10 pl-20">
                <div className="absolute left-0 w-16 h-16 rounded-2xl bg-[#a8d634]/10 border border-[#a8d634]/30 flex items-center justify-center">
