...
var define_IMAGES_REMOTE_PATTERNS_default = [{ protocol: "https", hostname: "^(?:^(?:avatars\\.githubusercontent\\.com)$)$", pathname: "^(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)\\/?)$" }, { protocol: "https", hostname: "^(?:^(?:images\\.unsplash\\.com)$)$", pathname: "^(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)\\/?)$" }];
...
// ../../node_modules/.pnpm/@opennextjs+cloudflare@1.19.11_next@15.3.0_@opentelemetry+api@1.9.1_react-dom@19.2.7_react@19_4prbyombhjlczdqb22cego2t7q/node_modules/@opennextjs/cloudflare/dist/cli/templates/images.js
